...
class Recipe
{
    ...
    public function addIngredient($item, $amount = null, $measure = null)
    {
        ...
        if ($measure != null && !in_array(strtolower($measure), $this->measurements)) {
            throw new InvalidArgumentException("Please enter a valid measurement: " . implode(", ", $this->measurements));
        }
    ...
    {
        $this->tags = array_merge($this->tags, explode(',', strtolower(str_replace(', ', ',',$tag))));
    }
